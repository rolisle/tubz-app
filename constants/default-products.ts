...
function p(id: string, name: string, category: Product["category"]): Product {
...
export const DEFAULT_PRODUCTS: Product[] = [
  ...
  p("tubz-hb-minimallows", "HB Minimallows", "sweet"),
  ...
  p("tubz-rainbow-pencils", "Rainbow Assorted Pencils", "sweet"),
  ...
  p("white-choc-snowies", "White Chocolate Snowies", "sweet"),
  ...
  p("rough-rider-4d-tattoos", "Rough Rider 4D Tattoos", "toy"),
  ...
  p("sqwishland-city", "Sqwishland City", "toy"),
  ...
  p("wakee-racers", "Wakee Racers", "toy"),
